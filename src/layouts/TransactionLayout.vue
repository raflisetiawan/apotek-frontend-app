<template>
  <div id="transaction-layout" style="background-color: #22411F; overflow: hidden;">
    <q-layout view="hHh lpR fFf">
      <q-header></q-header>
      <q-toolbar class="q-mt-md">
        <q-btn flat round size="lg" color="white" icon="fa-solid fa-list" class="q-mr-sm"
          @click="drawerLeft = !drawerLeft" />
        <div class="text-h6 text-white">{{ getTitle.name }}</div>
      </q-toolbar>
      ...
      <q-footer style="background-color: #22411F;">
        <q-toolbar class="justify-around">
          <q-btn icon="fa-solid fa-house" flat :to="{ name: 'HomePage' }" color="white"></q-btn>
        </q-toolbar>
      </q-footer>
...
const { $state: getTitle } = useTitleStore();
